...
def build_document(diagrams):
    ...
    chapter_sections = [
        ...
        ("Chapter 10: Results, Limitations and Future Work", [
            ("10.1 Results and Achievements", "the final system integrates attractive public, customer and staff experiences with functional server-side behavior.", "thirteen database tables and multiple roles support the full order lifecycle", "project objectives are substantially achieved"),
